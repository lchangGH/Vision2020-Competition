...
# My 2019 license: use it as much as you want. 
# Some parts of the code are based on 2019 code from the Screaming Chickens 3997
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # The follow overlays the words Aligned on the camera stream if Network table
        # Value of Align has been set.  We could use this for determing when the
        # target is Aligned (for Example)
