...
while(True):
    ...
    if abs(height) > 0:
        ...
        heightTarget = 17 #height of half hexagon
        #distancetoTarget = 156 #of best pic
        #realFocalLength = height*(distancetoTarget/heightTarget)
        #print('the actual focal length is', realFocalLength, 'pixels')

        #calculate distance using real focal length
        realFocalLength = 599.8223607680377 #in pixels
        distanceCalc = heightTarget*(realFocalLength/height)
